...
//                        new QueryBalancerEvent(serviceId, ingestMessage.getJMSCorrelationID(), this.poolSize,
...
//
//            synchronized (this) {
//                sendEventToMessageBroker(new QueryBalancerEvent(serviceId, ingestMessage.getJMSCorrelationID(),
